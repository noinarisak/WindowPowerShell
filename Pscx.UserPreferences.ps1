...
@{
    ...
    CD_GetChildItem = $true           # Display the contents of new provider location after using 
    ...
    PromptTheme = 'Jachym'            # Prompt string and window title updates.  To enable, first
